...
echo " 2. 'arti-ops setup' 명령어를 통해 최초 1회 글로벌 인증(API키 등)을 등록하세요."
echo " 3. 작업할 디렉토리에서 'arti-ops init' 명령어를 실행하여 로컬 워크스페이스를 구성하세요."
echo ""
echo "사용 예시:"
echo " $ arti-ops setup # 글로벌 환경 및 인증 설정"
echo " $ arti-ops init  # 현재 디렉토리 프로젝트 세팅"
echo " $ arti-ops       # 대화형 TUI 프롬프트 진입"
echo ""
